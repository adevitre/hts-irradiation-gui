...
class LIFT1_tab_Tc(QWidget):
    
    measure_signal = pyqtSignal(float, float, float, int, bool, str)
    updatePlot_signal = pyqtSignal()
    
    def __init__(self, parent=None):
        super(LIFT1_tab_Tc, self).__init__(parent)
        self.parent = parent
        ...
        self.QSpinBox_transportCurrent = QSpinBox(self)
        self.QSpinBox_transportCurrent.setRange(1, 100)
        self.QSpinBox_transportCurrent.setValue(1)
        self.QSpinBox_transportCurrent.setSingleStep(1)
